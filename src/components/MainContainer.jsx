  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
      ...
      <div className='flex items-center gap-2 justify-center bg-green-100 px-4 py-1 rounded-full'>
        ...
        <button type='button' className='bg-gradient-to-br from-green-600 to-green-500 rounded-lg w-full px-4 py-2 hover:shadow-lg transition-all ease-in-out duration-100'>Order Now</button>
      </div>
